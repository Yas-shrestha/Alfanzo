                ...
                <div class="container-fluid p-4">
                    ...
                    <div class="pagetitle">
                        <div class="d-flex justify-content-between">
                            <h1>View</h1>
                            <a href="{{ route('carousels.index') }}" class="btn btn-primary btn-md ">Back</a>
                        </div>
                        <nav>
                            <ol class="breadcrumb">
                    ...
                    <section class="section">
                        <div class="row">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('carousels.show', $carousels->id) }}" method="POST"
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                                        ...
                                                        value="{{ $carousels->title }}" disabled>
                                                    @error('title')
                                                        <small>{{ $message }}</small>
                                                    @enderror
                                                </div>
