                ...
                <div class="container-fluid p-4">
                    <div class="pagetitle">
                        ...
                        <div class="d-flex justify-content-between">
                            <h1>Manage file</h1>
                            <a href="{{ route('galleries.create') }}" class="btn btn-primary"> Add</a>
                        </div>
                        <nav>
                            <ol class="breadcrumb">
                                        ...
                                        <tbody>
                                            @foreach ($galleries as $gallery)
                                                <tr>
                                                    ...
                                                    <td><a target="_blank"
                                                            href="{{ url('uploads/' . $gallery->files->img) }}"><img
                                                                src="{{ asset('uploads/' . $gallery->files->img) }}"
                                                    ...
                                                    <td>
                                                        ...
                                                        <button type="button" class="btn btn-danger btn-md"
                                                            ...
                                                            data-bs-target="#modalId{{ $gallery->id }}">
                                                            <i class="fa-solid fa-trash-can"></i>
                                                        </button>

                                                        <!-- Modal Body -->
                                                        <!-- if you want to close by clicking outside the modal, delete the last endpoint:data-bs-backdrop and data-bs-keyboard -->
                                                        <div class="modal fade" id="modalId{{ $gallery->id }}"
