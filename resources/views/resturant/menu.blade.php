...
@section('container')
    ...
    @endforeach
    <div class="container">
        <h1 class="display-3 mb-3 animated slideInDown  text-white">Our Menu</h1>
    ...
    <div class="text-center mb-3">
        ...
        <div>
            {!! QrCode::size(200)->generate(asset('pdf/Alfanzo.pdf')) !!}
        </div>
    </div>
    <style>
        .food-menu img {
    ...
    <div class="menu-container mb-3">
        <div class="food-menu">
            <h1 class="text-primary text-center text-decoration-underline mt-3">Menu</h1>
            <img src="{{ asset('assets/img/menu/Alfanzoo-Resort_page-0001.jpg') }}" alt="">
            <img src="{{ asset('assets/img/menu/Alfanzoo-Resort_page-0002.jpg') }}" alt="">
            <img src="{{ asset('assets/img/menu/Alfanzoo-Resort_page-0003.jpg') }}" alt="">
            <img src="{{ asset('assets/img/menu/Alfanzoo-Resort_page-0004.jpg') }}" alt="">
            <img src="{{ asset('assets/img/menu/Alfanzo3.jpg') }}" alt="">
            <img src="{{ asset('assets/img/menu/Alfanzo4.jpg') }}" alt="">
            <img src="{{ asset('assets/img/menu/Alfanzo5.jpg') }}" alt="">
            <img src="{{ asset('assets/img/menu/Alfanzo6.jpg') }}" alt="">
            <img src="{{ asset('assets/img/menu/Alfanzo7.jpg') }}" alt="">
            <img src="{{ asset('assets/img/menu/Alfanzo8.jpg') }}" alt="">
        </div>
    </div>
    </div>
    <!-- Product Start -->
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    @foreach ($teams as $team)
                        ...
                        height:14rem; width:100%;object-fit:cover;object-position:top">
                                </div>
                                <h5 class="mb-0" data-bs-toggle="modal" data-bs-target="#teamID{{ $team->id }}"
                                    style="cursor: pointer">{{ $team->name }}</h5>
                                <small class="text-primary">{{ $team->post }}</small>
