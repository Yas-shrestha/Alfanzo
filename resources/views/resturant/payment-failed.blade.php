...
@section('container')
    ...
    @endforeach
    <div class="container">
        <h1 class="display-3 mb-3 animated slideInDown  text-white">Payment Failed</h1>
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a class="text-body" href="#">Home</a></li>
                <li class="breadcrumb-item text-light active" aria-current="page">Payment Failed</li>
            </ol>
        </nav>
    </div>
    </div>
